describe('prueba de busqueda de carros', () => {
  ...
  it('abri pagina', () => {
    ...
    //Ingresa la localidad de recogida
    ...
    //Ingresa la localidad de entrega
    ...
    //Ingresa al modal de calendario, dando clic a el pick up date 
    ...
    //Verifica que las tarjetas de vehículo esten activas (disponibilidad)
